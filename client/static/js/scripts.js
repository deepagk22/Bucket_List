var Bucketapp = angular.module('Bucketapp', ['ngRoute', 'ngCookies']);
...
Bucketapp.factory('BucketFactory', function ($http)
{
	 var factory = {};
...
Bucketapp.controller('LogoutController', function ($scope,$cookieStore,$location,BucketFactory) 
    {
    ...
    Bucketapp.controller('BucketController', function ($scope,$cookieStore,$location,BucketFactory) 
    {
...
Bucketapp.controller('MainController', function ($scope,$cookieStore, $location,BucketFactory){
	$scope.showBtn= false;
    ...
    Bucketapp.controller('dashController', function ($scope,$cookieStore, $location,BucketFactory) 
    {
...
Bucketapp.controller('showController', function ($scope, $route,BucketFactory) 
    {
      

      	// BucketFactory.getShowDone(function(name){
       //      	$scope.done= name;
       //      });
